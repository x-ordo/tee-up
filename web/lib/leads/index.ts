/**
 * @deprecated 이 모듈은 기존 "중개 플랫폼" 코드입니다.
 * chat_rooms 기반 리드 추적은 더 이상 사용되지 않습니다.
 *
 * 새로운 리드 시스템은 site_events 테이블을 기반으로 합니다.
 * web/src/actions/leads.ts를 사용하세요.
 * 이 파일은 향후 삭제 예정입니다.
 *
 * ---
 * 리드 추적 라이브러리 (DEPRECATED)
